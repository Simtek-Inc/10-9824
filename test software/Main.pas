...
////////////////////////////////////////////////////////////////////////////////////
        ...
        if ((tmp1 and $01) = $01) then lblSASON.Tag := 1 else lblAP1ON.Tag := 0;
        if ((tmp1 and $02) = $02) then lblATTON.Tag := 1 else lblAP2ON.Tag := 0;
        if ((tmp1 and $04) = $04) then lblTESTON.Tag := 1 else lblFDSEL1ON.Tag := 0;
        if ((tmp1 and $08) = $08) then lblRAD_ALTON.Tag := 1 else lblFDSEL2ON.Tag := 0;
        if ((tmp1 and $10) = $10) then lblVELHLDON.Tag := 1 else lblCOLLON.Tag := 0;
...
//    else
//    begin
//      SMsg := cleanRxBuffer(2);  // not start byte
//    end;
//    end;// while
      ...
      begin
        ...
        if (Pos('FDSEL1', UName) > 0) or
           (Pos('FDSEL2', UName) > 0) then
            ...
            BaseColor := clRed   // maroon

        else
            BaseColor := clLime;        // default green
